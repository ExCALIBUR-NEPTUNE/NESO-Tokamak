...
struct norm
{
    static constexpr REAL time        = 1.0E-4;
    static constexpr REAL length      = -1;
    static constexpr REAL mass        = 1.66053904e-27;
    static constexpr REAL charge      = 1.602176634e-19;
    static constexpr REAL temp        = 1.0;
    static constexpr REAL temp_SI     = 11604.51812;
    static constexpr REAL dens        = 1e18;
    static constexpr REAL mass_amu    = 1.0;
    static constexpr REAL mass_amu_SI = mass * mass_amu;
    static constexpr REAL kB          = 1.380649e-23;
    static inline const REAL vel      = std::sqrt((2 * charge) / mass);
    static inline const REAL potential_energy =
...
struct AMJUEL
{
    ...
    static inline const auto fetch_amjuel_coeffs(const std::string &filename)
    {
    ...
    static constexpr REAL amjuel_cs_norm = 1E-4;
    ...
    static inline const auto h10_2_1_8_coeffs =
        AMJUEL::fetch_amjuel_coeffs<num_coeffs_T, num_coeffs_np>(
            "data/H.10_2.1.8.csv");
    ...
    static inline const auto h3_3_1_8_coeffs =
        AMJUEL::fetch_amjuel_coeffs<num_coeffs_E, num_coeffs_T>(
            "data/H.3_3.1.8.csv");
    ...
    static constexpr std::array<REAL, h1_3_1_8_num_coeffs> h1_3_1_8_coeffs = {
    ...
    static constexpr std::array<REAL, h1_3_1_8_num_l_coeffs> h1_3_1_8_l_coeffs =
        {-3.294589355000e+01, -1.713112000000e-01, 0.000000000000e+00};

    static constexpr std::array<REAL, h1_3_1_8_num_r_coeffs> h1_3_1_8_r_coeffs =
        {-5.787734011000e+01, 7.671416829000e+00, -5.208376804000e-01};

    static constexpr REAL h1_3_1_8_elabmin = 0.10000e0;
    static constexpr REAL h1_3_1_8_elabmax = 5.00000e0;
    static constexpr REAL h1_3_1_8_emax    = 1.0e6;

    static inline const auto cx_rate_data(REAL parent_mass, REAL child_mass)
    {
    ...
    static inline const auto amjuel_fit_cross_section(REAL reduced_mass)
    {
