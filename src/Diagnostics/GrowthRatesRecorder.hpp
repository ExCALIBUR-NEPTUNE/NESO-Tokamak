#ifndef HW_IMPURITY_TRANSPORT_GROWTH_RATES_RECORDER_H
#define HW_IMPURITY_TRANSPORT_GROWTH_RATES_RECORDER_H
...
#endif // HW_IMPURITY_TRANSPORT_GROWTH_RATES_RECORDER_H