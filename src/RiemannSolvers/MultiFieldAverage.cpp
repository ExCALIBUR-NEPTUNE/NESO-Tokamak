#include "MultiFieldAverage.hpp"

namespace NESO::Solvers::tokamak
{
std::string MultiFieldAverageSolver::solverName =
    SU::GetRiemannSolverFactory().RegisterCreatorFunction(
        "MultiFieldAverage", MultiFieldAverageSolver::create, "Average solver");
 ...
 */
MultiFieldAverageSolver::MultiFieldAverageSolver(
 ...
 */
void MultiFieldAverageSolver::v_ArraySolve(
